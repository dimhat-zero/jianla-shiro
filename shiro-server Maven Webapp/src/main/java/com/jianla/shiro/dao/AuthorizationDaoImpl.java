...
public class AuthorizationDaoImpl implements AuthorizationDao {
	...
	public Authorization updateAuthorization(Authorization authorization) {
		...
		jdbcTemplate.update(sql, authorization.getUserId(), authorization.getAppId(), authorization.getRoleIdsStr(),
				authorization.getId());
		return authorization;
	}
	...
	public Authorization findOne(Long authorizationId) {
		...
		List<Authorization> authorizationList = jdbcTemplate.query(sql, new BeanPropertyRowMapper<Authorization>(
				Authorization.class), authorizationId);
	...
	public Authorization findByAppUser(Long appId, Long userId) {
		...
		List<Authorization> authorizationList = jdbcTemplate.query(sql, new BeanPropertyRowMapper<Authorization>(
				Authorization.class), appId, userId);
		if (authorizationList.size() == 0) {
			return null;
		}
		return authorizationList.get(0);
